...
import copy
from app.pymca import PyMcaPrintPreview
...
DEBUG = 0
class ScanWindow(qt.QWidget, Plot1DBase.Plot1DBase, logger.LocalLogger):
    def __init__(self, parent=None, name="Scan Window", specfit=None, debug_level=None):
    ...
    def _build(self):
        ...
        # Scan infor widget
        self.scanWindowInfoWidget = ScanWindowInfoWidget.ScanWindowInfoWidget(self)
